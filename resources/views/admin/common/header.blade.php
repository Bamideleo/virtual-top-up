        ...
        ***********************************-->
        <div class="nav-header">
           <a href="{{route('admin.dashboard')}}" class="brand-logo">
            ...
            <a href="{{route('admin.dashboard')}}" class="brand-logo-i m-t-5">
                <p>&nbsp;</p>
                <img  src="{{asset('images/'.$site_info->site_logo)}}" alt="" style="width:50px;height:50px">
            </a>
                    ...
                    <li class="nav-item dropdown notification_dropdown">
                        <a class="nav-link  ai-icon" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                           <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="badge light text-white bg-primary rounded-circle">{{$notification}}</span>
                            @endif
                        </a>
                                    ...
                                    <li>
                                        ...
                                        <div class="media me-2 media-info">
                                            ...
                                            <div class="media-body">
                                                <a href="{{route('admin.get-notification', $note->id)}}" class="mb-1">{{$note->subject}}</a>
                                            </div>
                                        </div>
                                    </li>
                                    @endforeach
...
@include('admin.common.sider_bar')
@endsection
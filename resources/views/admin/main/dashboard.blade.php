			...
			<div class="col-xl-2 col-xxl-4 col-sm-6">
				<div class="card bg-warning invoice-card">
					<div class="card-body d-flex">
						...
						<div>
							<h2 class="text-white invoice-num">{{$t_user}}</h2>
			...
			<div class="col-xl-2 col-xxl-4 col-sm-6">
				<div class="card bg-info invoice-card">
					<div class="card-body d-flex">
						...
						<div>
							<h2 class="text-white invoice-num">{{$payment}}</h2>
							<span class="text-white fs-18">Payment Invoices</span>
						</div>
					</div>
				</div>
			</div>
			<div class="col-xl-2 col-xxl-4 col-sm-6">
				<div class="card bg-secondary invoice-card">
					<div class="card-body d-flex">
						...
						<div>
							<h2 class="text-white invoice-num">{{$wallet}}</h2>
							<span class="text-white fs-18">wallet Invoices</span>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-xl-2 col-xxl-4 col-sm-6">
				<div class="card bg-secondary invoice-card">
					<div class="card-body d-flex">
						...
						<div>
							<h2 class="text-white invoice-num">{{$t_referral}}</h2>
							<span class="text-white fs-18">Total Referral</span>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="row align-items-center">
							<div class="col-xl-6">
								<div class="card-bx bg-blue">
									<img class="pattern-img" src="{{asset('assets_1/images/pattern/pattern6.png')}}" alt="">
									<div class="card-info text-white">
										<img src="assets_1/images/pattern/circle.png" class="mb-4" alt="">
											
										<h2 class="text-white card-balance" id='cb-i' style='display:none'>&#8358;{{number_format($m_payment,2)}}</h2>
											<h2 class="text-white card-balance" id="cb">*******</h2>
											<span>
							<i class="fa fa-eye-slash" id="income-i"></i>
							<i class="fa fa-eye" style='display:none' id="income-ii"></i>
						        </span>
										<p class="fs-16">Monthly Revenu</p>
							
										<!-- <span>+0,8% than last week</span> -->
									</div>
									<img class="" width="150" height="200" src="{{asset('assets_1/images/card.png')}}" alt="">
								</div>
							</div>
							<div class="col-xl-6">
								<div class="row align-items-center  mt-xl-0 mt-4">
									<div class="col-md-6">
										<h4 class="card-title">Analysis Overview's</h4>
										<!-- <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit psu olor</span> -->
										<ul class="card-list mt-4">
										
											<li><span class="bg-success circle"></span>Monthly Income<span id="m-income">&#8358;{{number_format($m_payment,2)}}</span></li>
									<li><span class="bg-success circle"></span>Vtpass Balance<span>&#8358;{{number_format($vtpass,2)}}</span></li>
										 <li><span class="bg-blue circle"></span>Epin Balance<span>&#8358;{{number_format($epin,2)}}</span></li> 
										</ul>
									</div>
									<div class="col-md-6" style="height:200px">
									<div class="mb-3">
                                    <label class="text-label form-label" for="dlab-password">Filter Income</label>
                                    <div class="input-group transparent-append">
									<input type="text" class="form-control wide border-right-end" name="tran_year" placeholder="Enter Year" id="year-filter">
                                    <select class="default-select form-control wide border-left-end @error('datatype') is-invalid @enderror" name="tran_date" id="month-filter">
							...
							<div class="table-responsive">
								<table class="table table-responsive-md card-table transactions-table">
									<tbody>
										...
										@forelse ($payment_1 as $transaction) 
										<tr>
											<td>
								...
								{{ $payment_1->links ('vendor.pagination.bootstrap-4') }}
							</div>
						</div>

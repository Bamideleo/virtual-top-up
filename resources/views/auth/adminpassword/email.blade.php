			...
			<div class="login-form">
                ...
                @csrf
					...
					<p class="text-center">Back to Login  
						<a class="btn-link text-primary" href="{{route('admin.login-view')}}">Login</a>
					</p>
				</form>
			</div>
		</div>
        <div class="col-xl-6 col-lg-6">
			<div class="pages-left h-100">
				<div class="login-content">
					<a href="index.html"><img src="{{asset('asset_1/images/logo-full.png')}}" class="mb-3" alt=""></a>
					
					<p>Your true value is determined by how much more you give in value than you take in payment. ...</p>
				</div>
				<div class="login-media text-center">
					<img src="{{asset('asset_1/images/login.png')}}" alt="">
				</div>
			</div>
        </div>
    </div>

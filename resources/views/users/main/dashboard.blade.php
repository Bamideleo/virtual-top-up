...
<div class="content-body ">
	...
	<div class="container-fluid">
		<div class="row invoice-card-row">
			...
			<div class="col-xl-3 col-xxl-3 col-sm-6" onclick="window.location.href='{{route('network.buy-data')}}'">
				<div class="card"  style="background:#fff;">
					<div class="card-body">
					<h4 style="text-align:center" class="mt-1"><a href="{{route('network.buy-data')}}" style="color:blue;">Click Here To Buy Data</a></h4>
					</div>
				</div>

			</div>

			<div class="col-xl-3 col-xxl-3 col-sm-6" onclick="window.location.href='{{route('network.airtime')}}'">
				<div class="card" style="background:#fff;">
					<div class="card-body">
					<h4 style="text-align:center" class="mt-1"><a href="{{route('network.airtime')}}" style="color:blue;">Click Here To Buy Airtime</a></h4>
					</div>
				</div>
			...
			<div class="col-xl-3 col-xxl-3 col-sm-6" onclick="window.location.href='{{route('tv.subscription')}}'">
				<div class="card"  style="background:#fff;">
					<div class="card-body">
					<h4 style="text-align:center;" class="mt-1"><a href="{{route('tv.subscription')}}" style="color:blue;">Click Here To Buy Cable TV</a></h4>
					</div>
				</div>

			</div>

			<div class="col-xl-3 col-xxl-3 col-sm-6" onclick="window.location.href='{{route('ibadan.electric')}}'">
				<div class="card"  style="background:#fff;">
					<div class="card-body">
					<h4 style="text-align:center" class="mt-1"><a href="{{route('ibadan.electric')}}" style="color:blue;">IBEDC Ibadan Electric Payment</a></h4>
					</div>
				</div>

			</div>

			<div class="col-xl-3 col-xxl-3 col-sm-6" onclick="window.location.href='{{route('electricity.bill')}}'">
				<div class="card"  style="background:#fff;">
					<div class="card-body">
					<h4 style="text-align:center" class="mt-1"><a href="{{route('electricity.bill')}}" style="color:blue;">IKEDC Ikeja Electric Payment</a></h4>
					</div>
				</div>

			</div>
			<div class="col-xl-3 col-xxl-3 col-sm-6" onclick="window.location.href='{{route('eko.electric')}}'">
				<div class="card"  style="background:#fff;">
					<div class="card-body">
					<h4 style="text-align:center" class="mt-1"><a href="{{route('eko.electric')}}" style="color:blue;">EKEDC Eko Electric Payment</a></h4>
					</div>
				</div>

			</div>
			<div class="col-xl-3 col-xxl-3 col-sm-6" onclick="window.location.href='{{route('kano.electric')}}'">
				<div class="card"  style="background:#fff;">
					<div class="card-body">
					<h4 style="text-align:center" class="mt-1"><a href="{{route('kano.electric')}}" style="color:blue;">KEDCO Kano Electric Payment</a></h4>
					</div>
				</div>

			</div>
			<div class="col-xl-3 col-xxl-3 col-sm-6" onclick="window.location.href='{{route('harcourt.electric')}}'">
				<div class="card"  style="background:#fff;">
					<div class="card-body">
					<h4 style="text-align:center" class="mt-1"><a href="{{route('harcourt.electric')}}" style="color:blue;">PHED Port Harcourt Electric Payment</a></h4>
					</div>
				</div>

			</div>

			<div class="col-xl-3 col-xxl-3 col-sm-6" onclick="window.location.href='{{route('jos.electric')}}'">
				<div class="card"  style="background:#fff;">
					<div class="card-body">
					<h4 style="text-align:center" class="mt-1"><a href="{{route('jos.electric')}}" style="color:blue;">JED Jos Electric Payment</a></h4>
					</div>
				</div>
			...
			<div class="col-xl-3 col-xxl-3 col-sm-6" onclick="window.location.href='{{route('kaduna.electric')}}'">
				<div class="card"  style="background:#fff;">
					<div class="card-body">
					<h4 style="text-align:center" class="mt-1"><a href="{{route('kaduna.electric')}}" style="color:blue;">KAEDCO Kaduna Electric Payment</a></h4>
					</div>
				</div>
			...
			<div class="col-xl-3 col-xxl-3 col-sm-6" onclick="window.location.href='{{route('abuja.electric')}}'">
				<div class="card"  style="background:#fff;">
					<div class="card-body">
					<h4 style="text-align:center" class="mt-1"><a href="{{route('abuja.electric')}}" style="color:blue;">AEDC Abuja Electric Payment</a></h4>
					</div>
				</div>
			...
			<div class="col-xl-3 col-xxl-3 col-sm-6" onclick="window.location.href='{{route('benin.electric')}}'">
				<div class="card"  style="background:#fff;">
					<div class="card-body">
					<h4 style="text-align:center" class="mt-1"><a href="{{route('benin.electric')}}" style="color:blue;">BEDC Benin Electric Payment</a></h4>
					</div>
				</div>
			...
			<div class="col-xl-3 col-xxl-3 col-sm-6" onclick="window.location.href='{{route('enugu.electric')}}'">
				<div class="card"  style="background:#fff;">
					<div class="card-body">
					<h4 style="text-align:center" class="mt-1"><a href="{{route('enugu.electric')}}" style="color:blue;">EEDC Enugu Electric Payment</a></h4>
					</div>
				</div>
			...
			<div class="col-xl-3 col-xxl-3 col-sm-6" onclick="window.location.href='{{route('network.smile-data')}}'">
				<div class="card"  style="background:#fff;">
					<div class="card-body">
					<h4 style="text-align:center" class="mt-1"><a href="{{route('network.smile-data')}}" style="color:blue;">Smile Data</a></h4>
					</div>
				</div>
			...
			<div class="col-xl-3 col-xxl-3 col-sm-6" onclick="window.location.href='{{route('wace.registration')}}'">
				<div class="card"  style="background:#fff;">
					<div class="card-body">
					<h4 style="text-align:center" class="mt-1"><a href="{{route('wace.registration')}}" style="color:blue;">Click Here To Buy Exam Pin</a></h4>
					</div>
				</div>
			...
			<div class="col-xl-3 col-xxl-3 col-sm-6">
				<div class="card"  style="background:#fff;">
					<div class="card-body">
				<h2 class="" style="color:blue;">{{$purchase}} <span class="fs-18">Purchase Invoices</span></h2>
			...
			<div class="col-xl-3 col-xxl-3 col-sm-6">
				<div class="card"  style="background:#fff;">
					<div class="card-body">
			<h2 style="color:blue;">{{$total_trans}} <span class="fs-18">Paid Invoices</span></h2>
					</div>
				</div>
			...
			<div class="col-xl-3 col-xxl-3 col-sm-6">
				<div class="card"  style="background:#fff;">
					<div class="card-body">
				<h2 class="" style="color:blue;">{{$t_referal}} <span class="fs-18">Total Referral</span></h2>
			...
			<div class="col-xl-3 col-xxl-3 col-sm-6">
				<div class="card"  style="background:#fff;">
					<div class="card-body">
				<h2 class="" style="color:blue;">&#8358; {{auth::user()->referal_point}} <a  href="#" id="r-bonus" data-id="{{auth::user()->id}}" data-type="{{auth::user()->referal_point}}"><span class="fs-18" style="color:blue;text-decoration:underline">Click Here To Claim Referral Bonus</span></a></h2>
		...
		<div class="col-xl-3 col-xxl-3 col-sm-6">
				<div class="card"  style="background:#fff;">
					<div class="card-body">
				<h2 style="color:blue;">&#8358; {{number_format(auth::user()->cashback)}} <a href="#" id="cash-back"><span style="color:blue;text-decoration:underline" class="fs-18">Claim Cashback Bonus</span></a></h2>
			...
			<!-- <div class="col-xl-3 col-xxl-3 col-sm-6">
				<div class="card bg-warning invoice-card">
					...
					<div class="card-body d-flex">
						...
						<div>
							<h2 class="text-white invoice-num">{{$purchase}}</h2>
							<span class="text-white fs-18">Purchase Invoices</span>
						</div>
					</div>
				</div>
			</div>
			<div class="col-xl-3 col-xxl-3 col-sm-6">
				<div class="card bg-success invoice-card">
					<div class="card-body d-flex">
						...
						<div>
							<h2 class="text-white invoice-num">{{$total_trans}}</h2>
						...
						<div class="row align-items-center">
							<div class="col-xl-6">
								<div class="card-bx bg-blue">
									<img class="pattern-img" src="assets_1/images/pattern/pattern6.png" alt="">
									<div class="card-info text-white">
										<img src="assets_1/images/pattern/circle.png" class="mb-4" alt="">
										@if(empty($wallet))
										<h2 class="text-white card-balance">&#8358;{{number_format(0, 2)}}</h2>
										@else
										<h2 class="text-white card-balance">&#8358;{{number_format($wallet->wallet, 2)}}</h2>
										@endif
										<p class="fs-16">Wallet Balance</p>
										<!-- <p class="fs-16">Coupon Code:WP-0cnkke</p> -->
									</div>
									<img class="" width="150" height="250" src="{{asset('assets_1/images/card.png')}}" alt="">
								...
								<div class="row align-items-center  mt-xl-0 mt-4">
									<div class="col-md-6">
										...
										<ul class="card-list mt-4">
											<li><span class="bg-blue circle"></span>Purchase Invoices<span>20%</span></li>
											<li><span class="bg-success circle"></span>Paid Invoices<span>40%</span></li>
											<li><span class="bg-warning circle"></span>Total Referral<span>15%</span></li>
								...
								<table class="table table-responsive-md card-table transactions-table">
									...
									@forelse ($data as $transaction) 
										<tr>
											...
											<td>
												<h6 class="fs-16 font-w600 mb-0"><a href="javascript:void(0);" class="text-black">{{$transaction->reference}}</a></h6>
